...
#ifndef TCSStackingAction_h
#define TCSStackingAction_h 1
...
class TCSStackingAction : public G4UserStackingAction
{
  public:
    TCSStackingAction();
    virtual ~TCSStackingAction();
  ...
  //Control parameters.
  bool fPrimaryOnly;      //keep primary particle only
  //  bool fAcceptanceOnly;   //keep tracks passing through OVC windows only.
