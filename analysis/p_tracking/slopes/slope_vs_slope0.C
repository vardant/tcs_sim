...
void slope_vs_slope0(string rootfile="RootFiles/p_pyz03thx18thy40.root",
		     int quarter=0, string comment="test") {
  ...
  TH2F* h_slope_vs_slope0 = new TH2F("h_slope_vs_slope0", htitle.c_str(),
				     100, -0.35, 0.10, 100, -0.5, 0.); //1.5GeV
				     //100, -0.3, 0.2, 100, -0.5, 0.); //0.9GeV
                                     //100, -0.25, 0.3, 100, -0.5, 0.); //0.7GeV
                                     //100, -0.15, 0.4, 100, -0.5, 0.); //0.5GeV

				     //100,0.15,0.55, 100, -0.1, 0.5); //1.5 GeV
				     //100, 0.2, 0.6, 100, -0.1, 0.5); //1.1 GeV
                                     //100, 0.2, 0.7, 100, -0.1, 0.5); //0.7 GeV
                                     //100, 0.3, 0.8, 100, -0.1, 0.5); //0.5 GeV
				     //100,-1.5,1.5, 100,-1.5,1.5); //0.3 GeV
  ...
  h_prof->Fit("pol1","","", -0.25, 0.01); //1.1 GeV/c
